...
void sendGPSData() {
  ...
  gpsSensor.setLongitude(50.824627);
  gpsSensor.setLatitude(3.250053);
  gpsSensor.setAltitude(altitude);
  altitude += 3.75;

  String text = "{\"lon\": " + String(gpsSensor.getLongitude()) + ", \"lat\": " + String(gpsSensor.getAltitude()) + "}";
...
void sendGPSSensor() {// 9
  ...
  ////debugSerial.println("long: " + gpsSens.)
  //sendGPSData();
...
void sloop() {
  ...
  if (sendGPS) {
    ...
    //debugSerial.println("sendGPS => true");
    sendGPS = false;
    sendGPSData();
    //sendEnCoSensor();
    ...
    //debugSerial.println("sendGPS => false");
...
void loop() {
  ...
  ////debugSerial.println("looping ==> connerction = " + String(connection));
